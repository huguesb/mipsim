...
void mips_init_processor(MIPS *m)
{
    ...
    hw->d = calloc(1, sizeof(MIPS_Processor_Private));
...
void mips_init_coprocessor(MIPS *m, int n)
{
    ...
    switch ( n )
    {
        case 0 :
            ...
            hw->d = calloc(1, sizeof(MIPS_CP0_Private));
            break;
        ...
        case 1 :
            ...
            hw->d = calloc(1, sizeof(MIPS_FPU_Private));
            break;
            
        default:
            hw->get_ctrl = _mips_get_gpr_cp;
            hw->set_ctrl = _mips_set_gpr_cp;
            hw->d = calloc(1, sizeof(MIPS_Coprocessor_Private));
            break;
    }
